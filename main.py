...
if isContinue:
	...
	with open(pathJSON) as file:
				...
				if isContinue:
					...
					idPosicion = fn.queryPositionJson(
						[
							...
							finalPosY,
							finalPosZ,
							# provisional si hay que marcar en el JSON las que se van tratando
							"C:/WorkPlace/Phyton/final.json",
						],
		...
		print(
			"Process succeed! Total positions in loop from Excel: " + str(rowExcelCount)
		)

	file.close
	print("JSON Positions file closed!")
